...
local Sizer = {
    ...
    scale = {caption = "SIZER - SCALE", label = {factor = "Size Factor"}},
    squares = {caption = "SIZER - SQUARES", label = {
        sq114 = "114x114",
        sq128 = "128x128",
        sq192 = "192x192",
        sq256 = "256x256",
    ...
    presets = {
        ...
        eight = {caption = "SIZER - PRESET - EIGHT BIT", label = {
        ...
        non = {caption = "SIZER - PRESET - NON STANDARD", label = {macMono = "Mac Mono [512 x 342]", macColor = "Mac Color [512 x 384]"}},
        ibm = {caption = "SIZER - PRESET - IBM STANDARD", label = {
        ...
        con = {caption = "SIZER - PRESET - CONSOLES", label = {
            nes = "NES [256 x 240]",
            snes = "SNES [256 x 224]",
        ...
        sprite = {caption = "SIZER - PRESET - SPRITES", label = {nesGb = "NES or GameBoy Sprite [8 x 8]", nesTall = "NES Tall Sprite [8 x 16]", snes = "SNES/GBA/DS Sprite [64 x 64]", gen = "Genesis Sprite [32 x 32]"}}
    }
}
...
local function scaleImage(f)
    ...
    local ok, factor = inputbox(
        Sizer.scale.caption,
        Sizer.scale.label.factor,
        2,
        0,
        max,
        2
    ...
    local ____temp_0
    if ok == true then
        ____temp_0 = setpicturesize(scaleW, scaleH)
    else
        ____temp_0 = sizer(f)
    end
end
local function modifyImage(f)
    ...
    selectbox(
        Sizer.modify.caption,
        Sizer.modify.label.half,
        modifyHalf,
        Sizer.modify.label.dblHeight,
        modifyDblH,
        Sizer.modify.label.dblWidth,
        modifyDblW,
        Sizer.modify.label.quad,
        modifyQuad,
        Sizer.modify.label.gold,
        modifyGold,
        Sizer.label.back,
        lSizer
    )
...
local function presetEight(f)
    ...
    selectbox(
        Sizer.presets.eight.caption,
        Sizer.presets.eight.label.apple,
        appleHiRes,
        Sizer.presets.eight.label.atariE,
        atariModeE,
        Sizer.presets.eight.label.atariF,
        atariModeF,
        Sizer.presets.eight.label.cWide,
        c64Wide,
        Sizer.presets.eight.label.cga,
        cga,
        Sizer.presets.eight.label.msx,
        msx,
        Sizer.presets.eight.label.msx2,
        msx2,
        Sizer.presets.eight.label.msx28,
        msx2Mode8,
        Sizer.label.back,
        g
    )
...
local function presetNon(f)
    ...
    selectbox(
        Sizer.presets.non.caption,
        Sizer.presets.non.label.macMono,
        macMono,
        Sizer.presets.non.label.macColor,
        macColor,
        Sizer.label.back,
        g
    )
...
local function presetIbm(f)
    ...
    selectbox(
        Sizer.presets.ibm.caption,
        Sizer.presets.ibm.label.cga6,
        cgaMode6,
        Sizer.presets.ibm.label.ega,
        ega,
        Sizer.presets.ibm.label.vga,
        vga,
        Sizer.presets.ibm.label.svga,
        svga,
        Sizer.presets.ibm.label.xga,
        xga,
        Sizer.label.back,
        g
    )
...
local function presetCon(f)
    ...
    selectbox(
        Sizer.presets.con.caption,
        Sizer.presets.con.label.nes,
        nes,
        Sizer.presets.con.label.snes,
        snes,
        Sizer.presets.con.label.gen,
        genesis,
        Sizer.presets.con.label.gb,
        gb,
        Sizer.presets.con.label.gba,
        gba,
        Sizer.presets.con.label.ds,
        ds,
        Sizer.label.back,
        g
    )
...
local function presetSprite(f)
    ...
    selectbox(
        Sizer.presets.sprite.caption,
        Sizer.presets.sprite.label.nesGb,
        spriteNes,
        Sizer.presets.sprite.label.nesTall,
        spriteNesTall,
        Sizer.presets.sprite.label.snes,
        spriteSnes,
        Sizer.presets.sprite.label.gen,
        spriteGenesis,
        Sizer.label.back,
        g
    )
...
presetImage = function(f)
    ...
    selectbox(
        Sizer.presets.caption,
        Sizer.presets.label.eight,
        eight,
        Sizer.presets.label.nonStd,
        nonStd,
        Sizer.presets.label.ibmStd,
        ibmStd,
        Sizer.presets.label.conHh,
        conHh,
        Sizer.presets.label.sprite,
        sprite,
        Sizer.label.back,
        g
    )
...
local function squareImage(f)
    ...
    selectbox(
        Sizer.squares.caption,
        Sizer.squares.label.sq114,
        sq114,
        Sizer.squares.label.sq128,
        sq128,
        Sizer.squares.label.sq192,
        sq192,
        Sizer.squares.label.sq256,
        sq256,
        Sizer.squares.label.sq512,
        sq512,
        Sizer.squares.label.sq768,
        sq768,
        Sizer.squares.label.sq814,
        sq814,
        Sizer.label.back,
        g
    )
